...
string Escenario::get_description(){
     string descripcion=this->examine();
     descripcion+="\n";
     if(this->get_objetos_disponibles()!="")
     {
	  descripcion+="Puedes ver lo siguiente : \n";
	  descripcion+=this->get_objetos_disponibles();	  
     }
     return descripcion;	  
}

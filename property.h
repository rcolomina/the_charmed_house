...
// This a couple string-generic type. 
// Advantages that bring it are self information.
// A soft instronspection can be done with
// the string telling what is the purpose
// of the property
template<class T> class Property {
	public:
	  Property(){}
	  Property(string name):name(name){}
	  Property(string name,T value):name(name),value(value){}
